...
{
    public class SequenceNode<TBlackboard> : CompositeNode<TBlackboard>, ICompletionObserver<TBlackboard>
    {
        ...
        public void OnComplete(BehaviourTreeExecutor<TBlackboard> executor, BehaviourTreeExecutionData<TBlackboard> execution, BehaviourTreeStatus status)
        {
            ...
            if (execution.Statuses[node.Id] == BehaviourTreeStatus.Failure)
            {
